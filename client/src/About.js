          ...
          <div className='cardContainer'>
            ...
            <div className='bodyText left'>
              <b style={{fontSize:'1.3em'}}>The Purpose:</b><br/><br/>
               Harmoni is built to be particularly useful for a few specific sets of users. Firstly, Harmoni allows young or inexperienced musicians to experiment with the fundamentals of chordal structure and harmony. As students learn and begin to create their own compositions, Harmoni provides them with a baseline comparison for their work. Instead of having to check with friends or professors, these users can measure the “legality” of chords and chord progressions with Harmoni itself.
              <br/><br/>
              Secondly, Harmoni caters to experienced composers who often need to perform mundane harmonization tasks by providing them the opportunity to automate these processes. We hope that these professionals can leverage Harmoni to expedite their tedious workflows, allowing them to instead focus on more creative musical pursuits.
            ...
            <br/><br/><br/>
              ...
              <br/><br/>
              <b>Non-Musicians:</b> Five Northwestern students were randomly selected, and each was given three output files from Harmoni. None of the students had an extensive background in music theory, and all of the songs were familiar children’s rhymes (ex. Row Row Row Your Boat). We asked each user to rank each output MIDI file on a scale of 1 to 3, with 1 representing poorly harmonized/disjoint sounds, and 3 representing a cohesive, error-free sound.
              ...
              <b>Musicians:</b> Three music students were each asked to about a few theoretical factors of the three output MIDI files generated by Harmoni. We asked them to comment on the flow and intuitiveness of the chord progression, the sound of the overall harmonization, and what they would change overall.
              <div style={{padding:'10px 30px'}}>
            ...
            <div className='bodyText right'>
              ...
              <br/><br/>
              <b>Rhythmic Improvements:</b> Harmoni currently does not use harmonic rhythm to determine where a chord should be placed in a measure. We hope to change this in the future instead of simply placing a new chord under each melody note. This will improve the sound of the harmonized tune, and will help novice musicians understand concepts of orchestration and harmonic voice.
            </div>
            <div className='tint'>
